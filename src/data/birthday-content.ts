// ============================================================
// Easy customization — edit values here to personalize the site.
// ============================================================
...
export const timelineMoments = [
  { title: "Our First Chat", date: "The day it all began", description: "A tiny hello that quietly changed everything." },
  { title: "Our First Meet", date: "The moment I saw you", description: "The world went soft and slow — and I just knew." },
  { title: "Our First Trip", date: "Just us, the road, and laughter", description: "Every mile with you felt like coming home." },
...
export const reasonsToLove = [
  ...
  "Your kindness — quiet, constant, and endless.",
  "The way you hold my hand like you mean forever.",
  "Your little humming when you're happy.",
  "How your love makes me a better man every day.",
  "Because you're you — and that's enough for me, always.",
];
