  ...
  return (
    <section className="relative px-4 py-20 sm:px-6">
      ...
      <div className="relative mx-auto mt-14 max-w-2xl">
        <div
          aria-hidden
          className="absolute left-4 top-0 h-full w-px bg-gradient-to-b from-rose/60 via-lavender to-transparent sm:left-1/2 sm:-translate-x-1/2"
        />
        <ul className="space-y-10">
          {timelineMoments.map((m, i) => (
            ...
            >
              <span
                aria-hidden
                className="absolute left-2 top-3 grid h-5 w-5 place-items-center rounded-full bg-gradient-to-br from-rose to-plum text-[10px] text-white shadow-md shadow-rose/40 sm:left-auto sm:right-[-10px] sm:top-3"
                style={i % 2 === 1 ? { left: -10, right: "auto" } : undefined}
              >
                ❤
              </span>
              <div className="glass rounded-2xl p-5 text-left sm:inline-block sm:text-inherit">
